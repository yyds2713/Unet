...
if __name__ == '__main__':
    ...
    unet = UNet(nClasses, input_height, input_width)

    if os.path.exists('output/unet_model.h5'):
        unet.load_weights('output/unet_model.h5')
    ...
    tensorboard = TensorBoard(log_dir='logs/unet/')
